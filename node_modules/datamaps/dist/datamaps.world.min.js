                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            $(data).each(function (index, value) {
                                if (value.name == a.id){
                                    // alert(value.threat);
                                    window.str =  value.threat;
                                //    window.rec = value.threat;
                                }
                            });
                        }

                    });
                    return ['<div class="hoverinfo"> <strong style="color:white;font-size:15px;">' + a.properties.name+"<br>"+ "</strong>" +'<span style="color:white;">'+"This week "+'<span style="color:red;font-weight:bold;">'+window.str + "</span>" + " Attack happened"+ "</span>"+"</div>"].join('');
                },
                popupOnHover: !0,
                highlightOnHover: !0,
                highlightFillColor: "#de0202",
